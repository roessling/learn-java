...
public class Number {
	 ...
	 * @param a
	 * @param b
	 * @return Given two int values, return their sum. Unless the two values are
	 ...
	 * 
	 * @param n
	 * @return Given an int n, return the absolute difference between n and 21,
	 ...
	 * @param talking
	 * @param hour
	 * @return We have a loud talking parrot. The "hour" parameter is the
	 ...
	 * @param a
	 * @param b
	 * @return Given 2 ints, a and b, return true if one if them is 10 or if
	 *         their sum is 10.
	 */
	 ...
	 * @param b
	 * @param negative
	 * @return Given 2 int values, return true if one is negative and one is
	 ...
	 * 
	 * @param str
	 * @return Given a string, return a new string where "not " has been added
	 ...
	 * @param str
	 * @param n
	 * @return Given a non-empty string and an int n, return a new string where
	 ...
	 * 
	 * @param str
	 * @return Given a string, return a new string where the first and last
	...
	public String frontBack(String str) {
		if (str.length() > 1) {
			...
			String tmpStr = end + str.substring(1, str.length() - 1) + start;
			return tmpStr;
		} else
			return str;
	}
	 ...
	 * 
	 * @param str
	 * @return Given a string, take the last char and return a new string with
	 ...
	 * 
	 * @param n
	 * @return Return true if the given non-negative number is a multiple of 3
	 ...
	 * 
	 * @param str
	 * @return Given a string, take the first 2 chars and return the string with
	 ...
	 * 
	 * @param str
	 * @return Given a string, return true if the string starts with "hi" and
	 *         false otherwise.
	 */
	 ...
	 * @param a
	 * @param b
	 * @return Given 2 int values, return true if either of them is in the range
	 *         10..20 inclusive.
	 */
	 ...
	 * @param b
	 * @param c
	 * @return We'll say that a number is "teen" if it is in the range 13..19
	...
	/**
	 *TODO TCETTE METHODE N EST PAS IMPLEMENTé pour cause de similarité avec les autres
	 * @param a
	 * @param b
	 * @return We'll say that a number is "teen" if it is in the range 13..19
	 ...
	 * 
	 * @param str
	 * @return Given a string, if the string "del" appears starting at index 1,
	 ...
	 * 
	 * @param str
	 * @return Return true if the given string begins with "mix", except the 'm'
	 ...
	 * 
	 * @param str
	 * @return Given a string, return a string made of the first 2 chars (if
	 ...
	 * @param b
	 * @param c
	 * @return Given three int values, a b c, return the largest.
	 */
	 ...
	 * @param a
	 * @param b
	 * @return Given 2 int values, return whichever value is nearest to the
	 ...
	 * @param a
	 * @param b
	 * @return Given 2 int values, return true if they are both in the range
	 ...
	 * @param a
	 * @param b
	 * @return Given 2 positive int values, return the larger value that is in
	 ...
	 * 
	 * @param str
	 * @return Return true if the given string contains between 1 and 3 'e'
	 *         chars.
	 */
	 ...
	 * @param a
	 * @param b
	 * @return Given two non-negative int values, return true if they have the
	 ...
	 * 
	 * @param str
	 * @return Given a string, return a new string where the last 3 chars are
	 ...
	 * @param str
	 * @param n
	 * @return Given a non-empty string and an int N, return the string made
	 ...
	 * @param weekday
	 * @param vacation
	 * @return The parameter weekday is true if it is a weekday, and the parameter vacation is true if we are on vacation. We sleep in if it is not a weekday or we're on vacation. Return true if we sleep in.
	 */
	 ...
	 * @param aSmile
	 * @param bSmile
	 * @return We have two monkeys, a and b, and the parameters aSmile and
